...
repo_path = "D:\\Repositories\\Loftify"
apks_path = "D:\\Repositories\\Loftify\\build\\app\\outputs\\flutter-apk"
windows_release_path = (
    "D:\\Repositories\\Loftify\\build\\windows\\x64\\runner\\Release"
)
downloads_path = "D:\\Ruida\\Downloads"
dll_path = "D:\\Repositories\\Loftify\\tools\\dll"
iss_path = "D:\\Repositories\\Loftify\\tools\\Loftify.iss"
    ...
    for root, dirs, files in os.walk(apks_path):
        for file in files:
            ...
            if match:
                ...
                if abi == "":
                    new_file = f"Loftify-{version}.apk"
                else:
                    new_file = f"Loftify-{version}-{abi}.apk"
...
def zip_windows(version):
    ...
    zip_path = os.path.join(get_downloads_path(version), "Loftify-" + version + ".zip")
