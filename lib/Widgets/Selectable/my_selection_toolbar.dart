...
/// See also:
///
///   * [MyMobileTextSelectionToolbar.toolbarBuilder], which is of this type.
...
///    toolbar.
class MyMobileTextSelectionToolbar extends StatelessWidget {
  /// Creates an instance of CupertinoTextSelectionToolbar.
  const MyMobileTextSelectionToolbar({
    super.key,
  ...
  MyMobileTextSelectionToolbar.items({
    super.key,
    required this.anchorAbove,
    required this.anchorBelow,
    this.backgroundColor,
    this.dividerColor,
    this.toolbarBuilder = _defaultToolbarBuilder,
    required Widget Function(MyContextMenuItem) itemBuilder,
    required List<MyContextMenuItem> items,
  }) : children = items
            .map(
              (e) => CupertinoTextSelectionToolbarButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: CustomSingleChildLayout(
        ...
        child: _MobileTextSelectionToolbarContent(
          anchorAbove: anchorAboveAdjusted,
          anchorBelow: anchorBelowAdjusted,
...
class _RenderCupertinoTextSelectionToolbarShape extends RenderShiftedBox {
  ...
  bool get isAbove =>
      anchorAbove.dy >=
      (child?.size.height ?? 0.0) - _kToolbarArrowSize.height * 2;
...
//
// The anchor should be in global coordinates.
class _MobileTextSelectionToolbarContent extends StatefulWidget {
  const _MobileTextSelectionToolbarContent({
    required this.anchorAbove,
    required this.anchorBelow,
  ...
  @override
  _MobileTextSelectionToolbarContentState createState() =>
      _MobileTextSelectionToolbarContentState();
}

class _MobileTextSelectionToolbarContentState
    extends State<_MobileTextSelectionToolbarContent>
  ...
  @override
  void didUpdateWidget(_MobileTextSelectionToolbarContent oldWidget) {
...
class _MobileTextSelectionToolbarItems extends RenderObjectWidget {
  _MobileTextSelectionToolbarItems({
    super.key,
    required this.page,
    required this.children,
  ...
  @override
  _MobileTextSelectionToolbarItemsElement createElement() =>
      _MobileTextSelectionToolbarItemsElement(this);
}

// The custom RenderObjectElement that helps paginate the menu items.
class _MobileTextSelectionToolbarItemsElement extends RenderObjectElement {
  _MobileTextSelectionToolbarItemsElement(
    _MobileTextSelectionToolbarItems super.widget,
  );

  late List<Element> _children;
  final Map<_MobileTextSelectionToolbarItemsSlot, Element> slotToChild =
      <_MobileTextSelectionToolbarItemsSlot, Element>{};
  ...
  void _updateRenderObject(
      RenderBox? child, _MobileTextSelectionToolbarItemsSlot slot) {
    switch (slot) {
      case _MobileTextSelectionToolbarItemsSlot.backButton:
        renderObject.backButton = child;
      case _MobileTextSelectionToolbarItemsSlot.nextButton:
  ...
  void insertRenderObjectChild(RenderObject child, Object? slot) {
    if (slot is _MobileTextSelectionToolbarItemsSlot) {
    ...
    assert(false,
        'slot must be _MobileTextSelectionToolbarItemsSlot or IndexedSlot');
  }
  ...
  void forgetChild(Element child) {
    ...
    if (slotToChild.containsKey(child.slot)) {
      final _MobileTextSelectionToolbarItemsSlot slot =
          child.slot! as _MobileTextSelectionToolbarItemsSlot;
  ...
  void _mountChild(Widget widget, _MobileTextSelectionToolbarItemsSlot slot) {
  ...
  void mount(Element? parent, Object? newSlot) {
    ...
    final _MobileTextSelectionToolbarItems toolbarItems =
        widget as _MobileTextSelectionToolbarItems;
    _mountChild(toolbarItems.backButton,
        _MobileTextSelectionToolbarItemsSlot.backButton);
    _mountChild(toolbarItems.nextButton,
        _MobileTextSelectionToolbarItemsSlot.nextButton);

    // Mount list children.
    _children = List<Element>.filled(
        toolbarItems.children.length, _NullElement.instance);
  ...
  @override
  void update(_MobileTextSelectionToolbarItems newWidget) {
...
class _RenderCupertinoTextSelectionToolbarItems extends RenderBox
  ...
  final Map<_MobileTextSelectionToolbarItemsSlot, RenderBox> slottedChildren =
      <_MobileTextSelectionToolbarItemsSlot, RenderBox>{};

  late bool hasNextPage;
  late bool hasPreviousPage;

  RenderBox? _updateChild(RenderBox? oldChild, RenderBox? newChild,
      _MobileTextSelectionToolbarItemsSlot slot) {
    if (oldChild != null) {
      dropChild(oldChild);
  ...
  set backButton(RenderBox? value) {
    _backButton = _updateChild(
        _backButton, value, _MobileTextSelectionToolbarItemsSlot.backButton);
  }
  ...
  set nextButton(RenderBox? value) {
    _nextButton = _updateChild(
        _nextButton, value, _MobileTextSelectionToolbarItemsSlot.nextButton);
  }
...
enum _MobileTextSelectionToolbarItemsSlot {
  backButton,
  nextButton,
}
...
class MyDesktopTextSelectionToolbar extends StatelessWidget {
  /// Creates an instance of CupertinoTextSelectionToolbar.
