...
class BlogStatistic {
  ...
  factory BlogStatistic.fromJson(Map<String, dynamic> json) {
    return BlogStatistic(
      appLoginCount: json['appLoginCount'] ?? 0,
      avatarBoxId: json['avatarBoxId'] ?? 0,
      avatarBoxImage: json['avatarBoxImage'] ?? "",
      blacklistCount: json['blacklistCount'] ?? 0,
      blogCount: json['blogCount'] ?? 0,
      bulletinLoadTime: json['bulletinLoadTime'] ?? 0,
      favoritePostCount: json['favoritePostCount'] ?? 0,
      favoriteTagCount: json['favoriteTagCount'] ?? 0,
      followingCount: json['followingCount'] ?? 0,
      inviteCodeCount: json['inviteCodeCount'] ?? 0,
      lastLoginIp: json['lastLoginIp'] ?? "",
      lastLoginTime: json['lastLoginTime'] ?? 0,
      loginCount: json['loginCount'] ?? 0,
      postResponseCount: json['postResponseCount'] ?? 0,
      publishPostCount: json['publishPostCount'] ?? 0,
      questionBoxFetchTime: json['questionBoxFetchTime'] ?? 0,
      recommendCount: json['recommendCount'] ?? 0,
      robotLikeTime: json['robotLikeTime'] ?? 0,
      sharePostCount: json['sharePostCount'] ?? 0,
      subscribeCollectionViewTime: json['subscribeCollectionViewTime'] ?? 0,
      subscribePostCount: json['subscribePostCount'] ?? 0,
      uploadDiyMusicSize: json['uploadDiyMusicSize'] ?? 0,
      userId: json['userId'] ?? 0,
      userRemotePort: json['userRemotePort'] ?? 0,
    );
  }
