...
class ReleaseItem {
  ...
  factory ReleaseItem.fromJson(Map<String, dynamic> json) => ReleaseItem(
    assets: List<ReleaseAsset>.from(json["assets"].map((x) => ReleaseAsset.fromJson(x))),
    assetsUrl: json["assets_url"],
    author: json["author"] == null ? null : SimpleUser.fromJson(json["author"]),
    body: json["body"],
    ...
    reactions: json["reactions"] == null ? null : ReactionRollup.fromJson(json["reactions"]),
