...
class AssetUtil {
  ...
  static const String collectionPrimaryIcon = "assets/icon/collection_primary.png";
  ...
  static const String dynamicDarkSelectedIcon = "assets/icon/dynamic_dark_selected.png";
  static const String dynamicLightIcon = "assets/icon/dynamic_light.png";
  static const String dynamicLightSelectedIcon = "assets/icon/dynamic_light_selected.png";
  ...
  static const String homeDarkSelectedIcon = "assets/icon/home_dark_selected.png";
  static const String homeLightIcon = "assets/icon/home_light.png";
  static const String homeLightSelectedIcon = "assets/icon/home_light_selected.png";
