    ...
    for root, _, files in os.walk(folder_path):
        for file in files:
            if file.endswith(".png") or file.endswith(".jpg") or file.endswith(".jpeg") or file.endswith(".gif") or file.endswith(".webp") or file.endswith(".svg"):
                ...
                # 将文件名转换为驼峰命名
                variable_name = to_camel_case(base_name)+"Illust"
                # 生成代码行
                code_line = f'static const String {variable_name} = "assets/illust/{file}";'
                # 将代码行添加到列表中
