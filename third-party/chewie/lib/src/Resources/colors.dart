...
class ChewieColors {
  ...
  static Color unreadButtonColor = ChewieTheme.primaryColor;
  ...
  static const Color starButtonColor = Color(0xFFFFC107);
  static const Color readLaterButtonColor = Color(0xFF26A69A);
