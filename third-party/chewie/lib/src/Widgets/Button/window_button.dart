...
class WindowButtonColors {
  ...
  WindowButtonColors({
    ...
    this.normal = normal ?? defaultWindowButtonColors.normal;
    this.selected = selected ?? defaultWindowButtonColors.selected;
    this.mouseOver = mouseOver ?? defaultWindowButtonColors.mouseOver;
...
final defaultWindowButtonColors = WindowButtonColors(
...
class WindowButton extends StatelessWidget {
  ...
  WindowButton({
    ...
    this.colors = colors ?? defaultWindowButtonColors;
  }
